...
namespace HotelFlightAPI.Controllers
{
    ...
    public class FlightTicketController : ControllerBase
    {
        ...
        {
            return await _context.FlightTickets.AsNoTracking().ToListAsync();
        }
        ...
        {
            var flightTicket = await _context.FlightTickets.AsNoTracking().FirstOrDefaultAsync(ft => ft.Id == id);
        ...
        public async Task<IActionResult> UpdateFlightTicket(int id, FlightTicket flightTicket)
        {
            ...
            var existingTicket = await _context.FlightTickets.FindAsync(id);
            ...
            // Update properties
            existingTicket.Airline = flightTicket.Airline;
            existingTicket.FlightNumber = flightTicket.FlightNumber;
            existingTicket.DepartureCity = flightTicket.DepartureCity;
            existingTicket.DestinationCity = flightTicket.DestinationCity;
            existingTicket.DepartureDate = flightTicket.DepartureDate;
            existingTicket.ArrivalDate = flightTicket.ArrivalDate;
            existingTicket.Price = flightTicket.Price;
